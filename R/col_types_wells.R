...
col_types_wells_janitor <- readr::cols(
  well_tag_number = col_double(),
  identification_plate_number = col_double(),
  well_identification_plate_attached = col_character(),
  well_status_code = col_character(),
  ...
  consultant_company = col_character(),
  diameter_inches = col_character(),
  total_depth_drilled_ft_bgl = col_double(),
  finished_well_depth_ft_bgl = col_double(),
  final_casing_stick_up_inches = col_double(),
  bedrock_depth_ft_bgl = col_double(),
  ground_elevation_ft_asl = col_double(),
  ground_elevation_method_code = col_character(),
  static_water_level_ft_btoc = col_double(),
  well_yield_usgpm = col_double(),
  well_yield_unit_code = col_character(),
  artesian_flow_usgpm = col_double(),
  artesian_pressure_psi = col_double(),
  ...
  liner_thickness_inches = col_double(),
  surface_seal_thickness_inches = col_double(),
  liner_from_ft_bgl = col_double(),
  liner_to_ft_bgl = col_double(),
  screen_intake_method_code = col_character(),
  screen_type_code = col_character(),
  screen_material_code = col_character(),
  other_screen_material = col_character(),
  ...
  yield_estimation_rate_usgpm = col_double(),
  yield_estimation_duration_hours = col_double(),
  static_level_before_test_ft_btoc = col_double(),
  drawdown_ft_btoc = col_double(),
  hydro_fracturing_performed = col_character(),
  hydro_fracturing_yield_increase = col_double(),
  decommission_reason = col_character(),
  decommission_method_code = col_character(),
  ...
  avi_years = col_character(),
  storativity = col_double(),
  transmissivity_m_2_s = col_double(),
  hydraulic_conductivity_m_s = col_double(),
  specific_storage_1_m = col_character(),
  specific_yield = col_double(),
  testing_method = col_character(),
  testing_duration_hours = col_double(),
  analytic_solution_type = col_character(),
  boundary_effect_code = col_character(),
  aquifer_lithology_code = col_character(),
  artesian_pressure_head_ft_agl = col_double(),
  artesian_conditions = col_character()
)
...
col_types_geocoded_janitor <- 
  cols(
    full_address = col_character(),
    site_name = col_character(),
    unit_designator = col_character(),
    unit_number = col_double(),
    unit_number_suffix = col_character(),
    civic_number = col_double(),
    civic_number_suffix = col_character(),
    street_name = col_character(),
    street_type = col_character(),
    is_street_type_prefix = col_character(),
    street_direction = col_character(),
    is_street_direction_prefix = col_character(),
    street_qualifier = col_character(),
    locality_name = col_character(),
    locality_type = col_character(),
    electoral_area = col_character(),
    province_code = col_character(),
    location_positional_accuracy = col_character(),
    location_descriptor = col_character(),
    site_id = col_character(),
    block_id = col_double(),
    full_site_descriptor = col_character(),
    access_notes = col_character(),
    site_status = col_character(),
    site_retire_date = col_date(format = ""),
    change_date = col_date(format = ""),
    is_official = col_character(),
    distance = col_double(),
    well_tag_number = col_double()
  )
...
col_types_qa_janitor <- readr::cols(
  well_tag_number = col_double(),
  identification_plate_number = col_double(),
  well_identification_plate_attached = col_character(),
  well_status_code = col_character(),
  ...
  licenced_status_code = col_character(),
  intended_water_use_code = col_character(),
  observation_well_number = col_logical(),
  obs_well_status_code = col_logical(),
  water_supply_system_name = col_character(),
  water_supply_system_well_name = col_character(),
  street_address = col_character(),
  city = col_character(),
  ...
  screen_type_code = col_character(),
  screen_material_code = col_character(),
  other_screen_material = col_logical(),
  screen_information = col_character(),
  screen_opening_code = col_character(),
  screen_bottom_code = col_character(),
  other_screen_bottom = col_logical(),
  filter_pack_from_ft = col_logical(),
  filter_pack_to_ft = col_logical(),
  filter_pack_material_code = col_character(),
  filter_pack_thickness_inches = col_logical(),
  filter_pack_material_size_code = col_logical(),
  development_hours = col_double(),
  development_notes = col_character(),
  water_quality_colour = col_character(),
  water_quality_odour = col_character(),
  ...
  hydro_fracturing_yield_increase = col_logical(),
  decommission_reason = col_character(),
  decommission_method_code = col_character(),
  decommission_details = col_character(),
  decommission_sealant_material = col_character(),
  ...
  storativity = col_logical(),
  transmissivity_m_2_s = col_double(),
  hydraulic_conductivity_m_s = col_double(),
  specific_storage_1_m = col_logical(),
  specific_yield = col_logical(),
  testing_method = col_character(),
  testing_duration_hours = col_logical(),
  ...
  nr_region_name = col_character(),
  full_address = col_character(),
  street_address_2 = col_character(),
  civic_number = col_double(),
  civic_number_suffix = col_character(),
  street_name = col_character(),
  street_type = col_character(),
  is_street_type_prefix = col_logical(),
  street_direction = col_character(),
  is_street_direction_prefix = col_logical(),
  street_qualifier = col_logical(),
  locality_name = col_character(),
  distance_geocode = col_double(),
  distance_to_matching_pid = col_double(),
  score_address = col_double(),
  score_location_description = col_double(),
  score_city = col_double(),
  xref_ind = col_logical(),
  field_1 = col_double(),
  alr_ind = col_character(),
  btm_label = col_character(),
  esa_landclass = col_character(),
  geometry = col_logical(),
  date_qa = col_date(format = "")
)
